...
<div class="container-fluid content">
    ...
    <div class="page-header">
        <div class="pull-left">
            <ol class="breadcrumb visible-sm visible-md visible-lg">
                ...
                <li class="active"><a href="#">用户被投诉处理</a></li>
            </ol>
        </div>
    ...
    <div class="panel">
        ...
        <div class="panel-heading bk-bg-primary">
            <h6><i class="fa fa-table red"></i><span class="break"></span>被投诉用户列表</h6>
        </div>
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <?php if(is_array($free)): $i = 0; $__LIST__ = $free;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success" href="/admin/Assess/nodeal/id/<?php echo ($vo["users_id"]); ?>">
                                    忽略
                                </a>

                                <a class="btn btn-danger" href="/admin/Assess/deal/id/<?php echo ($vo["users_id"]); ?>">
                                    封禁
