...
<div class="container-fluid content">
	...
	<div class="page-header">
		<div class="pull-left">
			<ol class="breadcrumb visible-sm visible-md visible-lg">
				...
				<li class="active"><a href="#">新闻审核</a></li>
			</ol>
		</div>
	...
	<div class="panel">
		...
		<div class="panel-heading bk-bg-primary">
			<h6><i class="fa fa-table red"></i><span class="break"></span>新闻审核</h6>
		</div>
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					...
					<tbody>
					<?php if(is_array($posts)): $i = 0; $__LIST__ = $posts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><tr>
							<td><?php echo ($p["posts_id"]); ?></td>
							<td><?php echo ($p["posts_title"]); ?></td>
							<!--<td>
								<span class="label label-warning"><?php echo ($p["up_num"]); ?></span>
							</td>
							<td>
 ...
 switch ($p["boss_deal"]){ case 0: echo "还未审核"; break; case 1: echo "已审核"; break; case 2: echo "未通过审核"; break; default: echo 'error'; break; } ?></span>
							</td>-->
							<td>
								<a class="btn btn-success" id="<?php echo ($p["posts_id"]); ?>" href="/admin/Assess/upup/id/<?php echo ($p["posts_id"]); ?>">
									审核
								</a>

								<a class="btn btn-danger"  href="/admin/Assess/cancelup/id/<?php echo ($p["posts_id"]); ?>">
									拒绝
								</a>
							</td>
