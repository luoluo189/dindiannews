...
<div class="container-fluid content">
                        ...
                        <ul class="nav nav-sidebar">
                            ...
                            <li class="nav-parent">
                                ...
                                <ul class="nav nav-children">
                                    <li><a href="/review/assess/boutique"><span class="text"> 未审核新闻</span></a></li>
                                    <li><a href="/review/assess/goodNews"><span class="text">审核通过新闻</span></a></li>
                                    <li><a href="/review/assess/getPost"><span class="text">审核未通过新闻</span></a></li>
                            ...
                            <li class="nav-parent">
                                ...
                                <ul class="nav nav-children">
                                    <li><a href="/review/assess/appeal"><span class="text"> 用户被投诉处理</span></a></li>
                                    <li><a href="/review/assess/blacklist"><span class="text"> 黑名单管理</span></a></li>
    ...
    <div class="page-header">
        <div class="pull-left">
            <ol class="breadcrumb visible-sm visible-md visible-lg">
                ...
                <li class="active"><a href="#">新闻删除</a></li>
            </ol>
        </div>
    ...
    <div class="panel">
        ...
        <div class="panel-heading bk-bg-primary">
            <h6><i class="fa fa-table red"></i><span class="break"></span>投诉的新闻表</h6>
        </div>
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <?php if(is_array($posts)): $i = 0; $__LIST__ = $posts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
                        <tr>
                            <td><?php echo ($vo["posts_id"]); ?></td>
                            <td><?php echo ($vo["posts_title"]); ?></td>
                            <td><?php
 $id=$vo['posts_id']; $condiction['par_comments_id']=$id; $num= M('comments')->where($condiction)->count(); echo $num; ?></td>
                            <td>
                                <span class="label label-warning"><?php echo ($vo["charge_num"]); ?></span>
                            </td>
                            <td>
										<span class="label label-danger"><?php
 switch ($vo["boss_deal"]){ case 0: echo "未推送"; break; case 1: echo "已推送"; break; case 2: echo "投诉已忽略"; break; default: echo 'error'; break; } ?></span>
                            </td>
                            <td>
                                <a class="btn btn-success" href="/Review/Assess/postsIgnore?id=<?php echo ($vo["posts_id"]); ?>">
                                    忽略
                                </a>

                                <a class="btn btn-danger" href="/Review/Assess/delete?id=<?php echo ($vo["posts_id"]); ?>">
                                    删除
