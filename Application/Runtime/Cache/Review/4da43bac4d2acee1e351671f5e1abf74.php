...
<div class="container-fluid content">
                    ...
                    <nav id="menu" class="nav-main" role="navigation">
                        <ul class="nav nav-sidebar">
                            ...
                            <li class="nav-parent">
                                ...
                                <ul class="nav nav-children">
                                    <li><a href="/review/assess/notreview"><span class="text">审核未通过新闻</span></a></li>
 ...
 switch ($vo["boss_deal"]){ case 0: echo "未推送"; break; case 1: echo "已推送"; break; case 2: echo "投诉已忽略"; break; default: echo 'error'; break; } ?></span>
										...
										<td>
											<a class="btn btn-success" href="/Admin/Assess/postsIgnore?id=<?php echo ($vo["posts_id"]); ?>">
												忽略
											</a>

											<a class="btn btn-danger" href="/Admin/Assess/delete?id=<?php echo ($vo["posts_id"]); ?>">
												删除
