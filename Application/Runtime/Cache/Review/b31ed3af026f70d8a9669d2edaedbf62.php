...
<div class="container-fluid content">
    ...
    <div class="page-header">
        <div class="pull-left">
            <ol class="breadcrumb visible-sm visible-md visible-lg">
                ...
                <li class="active"><a href="#">未审核新闻</a></li>
            </ol>
        </div>
    ...
    <div class="panel">
        ...
        <div class="panel-heading bk-bg-primary">
            <h6><i class="fa fa-table red"></i><span class="break"></span>未审核新闻</h6>
        </div>
 ...
 switch ($p["news_type"]){ case 1: echo "picnews"; break; case 4: echo "videonews"; break; case 2: echo "wordnews"; break; case 3: echo "tuwennews"; break; default: echo 'elsenews'; break; } ?>/id/<?php echo ($p["news_id"]); ?>/"><?php echo ($p["news_title"]); ?></a></td>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger"  href="/review/Assess/cancelup/id/<?php echo ($p["news_id"]); ?>">
                                    拒绝
                                </a>
