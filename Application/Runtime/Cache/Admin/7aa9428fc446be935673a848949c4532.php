...
<div class="container-fluid content">
	...
	<div class="page-header">
		<div class="pull-left">
			<ol class="breadcrumb visible-sm visible-md visible-lg">
				...
				<li class="active"><a href="#">团队人员管理</a></li>
			</ol>
		</div>
	...
	<div class="panel">
		...
		<div class="panel-heading bk-bg-primary">
			<h6><i class="fa fa-table red"></i><span class="break"></span>团队人员列表</h6>
		</div>
		<div class="panel-body">
			<div class="table-responsive">
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					...
					<?php if(is_array($root_users)): $i = 0; $__LIST__ = $root_users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
						<tr>
							<td><?php echo ($vo["root_id"]); ?></td>
							<td><?php echo ($vo["root_name"]); ?></td>
							<td><?php echo ($vo["root_password"]); ?></td>
							<td>
								<span class="label label-warning"><?php echo ($vo["root_right"]); ?></span>
							</td>
							<td>
								<a class="btn btn-danger" href="/Admin/Assess/deleteManager?id=<?php echo ($vo["root_id"]); ?>">
									<!-- <a href="gzhDel?app_name=<?php echo ($vo["app_name"]); ?>">删 除</a> -->
									删除
								</a>
							</td>
						</tr>
