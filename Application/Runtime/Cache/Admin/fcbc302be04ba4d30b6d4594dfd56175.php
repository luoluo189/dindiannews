...
<div class="container-fluid content">
	...
	<div class="page-header">
		<div class="pull-left">
			<ol class="breadcrumb visible-sm visible-md visible-lg">
				...
				<li class="active"><a href="#">热点新闻推荐</a></li>
			</ol>
		</div>
	...
	<div class="panel">
		...
		<div class="panel-heading bk-bg-primary">
			<h6><i class="fa fa-table red"></i><span class="break"></span>新闻精华推荐</h6>
		</div>
 ...
 switch ($p["boss_deal"]){ case 0: echo "还未推送"; break; case 1: echo "已推送"; break; case 2: echo "投诉被忽略"; break; default: echo 'error'; break; } ?></span>
							</td>
							<td>
