...
<div class="aw-container-wrap">
    ...
    <div class="carousel-inner">
      <div class="item">
           <a href="content.html" target="_blank"><img alt="" src="/Public/images/1.jpg"></a>
         </div>
       <div class="item active">
            <a href="content.html" target="_blank"><img alt="" src="/Public/images/2.jpg"></a>
          </div>
        <div class="item">
             <a href="content.html" target="_blank"><img alt="" src="/Public/images/3.jpg"></a>
         </div>
     </div>
    <a class="left carousel-control" href="content.html" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left" style="font-size:14px;"></span></a>
    <a class="right carousel-control" href="content.html" data-slide="next">
 ...
 $('.carousel').carousel();
					...
					<ul class="nav nav-tabs aw-nav-tabs hidden-xs active">
						<li class="active"><a href="/index.php/home/list/index">等待评论</a></li>
						<li><a href="/index.php/home/list/index" id="sort_control_hot">热门</a></li>
						<li><a href="/index.php/home/list/index">推荐</a></li>
						<li><a href="/index.php/home/list/index">最新</a></li>

						<h2 class="hidden-xs"><i class="icon icon-wechat" style="font-size:20px;color:#000;"></i> 话题</h2>
					</ul>
					<!-- end tab切换 -->
					...
					<div class="aw-mod aw-explore-list">
						<div class="mod-body">
							<div class="aw-common-list">
								<?php if(is_array($posts)): $i = 0; $__LIST__ = $posts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><div class="aw-item" id="aw-item_0">
	<div class="aw-user-imgs">
	<a class="aw-user-name aw-user-name-o hidden-xs" data-id="3" href="/index.php/home/personal/index2/id2/<?php echo ($p[users_id]); ?>" rel="nofollow"><img src="/Public<?php
 $usersid=$p[users_id]; $tmp['users_id']=$usersid; $usersName=M('users')->where($tmp)->field('users_pic')->find(); echo $usersName['users_pic']; ?>" alt=""><p><!--用户名-->
		<?php
 $usersid=$p[users_id]; $tmp['users_id']=$usersid; $usersName=M('users')->where($tmp)->field('users_name')->find(); echo $usersName['users_name']; ?>
	</p><i class="icon icon-v"></i></a>	<div class="userline hidden-xs" id="userline_0"></div>
	</div>

	<div class="aw-question-content" id="aw-question-content_0">
		<h4>
						<span class="spanb_b">热</span>									<a href="/index.php/home/list/content/id/<?php echo ($p["posts_id"]); ?>">
			<?php
 $tabid=$p[posts_label_id]; $tmp['posts_label_id']=$tabid; $tabName=M('lables')->where($tmp)->field('posts_label_name')->find(); echo "【".$tabName['posts_label_name']."】"; ?>

			<?php echo ($p["posts_title"]); ?></a>
		</h4>	
		<div class="inner clearfix">
				<div class="inner clearfix question-text" style="color: #666; font-size:13px;">
						<?php echo ($p["posts_intr"]); ?>		</div>
				<div class="inner clearfix">
																<a href="/index.php/home/personal/index" class="aw-user-name">
																<!--用户名-->	[<?php
 $usersid=$p[users_id]; $tmp['users_id']=$usersid; $usersName=M('users')->where($tmp)->field('users_name')->find(); echo $usersName['users_name']; ?>]</a>
				<span class="text-color-999">发起了话题 o <?php
 $postsid=$p['posts_id']; $tmp['posts_id']=$postsid; $num=M('comments')->where($tmp)->count(); echo $num; ?> 个评论 o  <?php echo ($p["posts_time"]); ?>
				</span>
													<span class="pull-right hidden-xs contribute text-color-999">
				<a href="/index.php/home/list/content/id/<?php echo ($p["posts_id"]); ?>" class="pull-right aw-icon-thank-tips text-color-999" data-original-title="评论" data-toggle="tooltip" title="" data-placement="bottom">评论 </a>
				</span>
								</div>
		</div>
	</div>
...
</div>										<div class="aw-mod aw-text-align-justify" id="saybox">
	</div>
<script type="text/javascript">
$(function(){
	var scrtime;
...
</script>					<div id="tabuzhead" class="hidden-xs hidden-sm fixedff">
	<div class="tabuzheadboxs">
		<a target="_blank"><img src="/Public/images/AD1.jpg"></a>
	</div>
