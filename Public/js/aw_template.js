var AW_TEMPLATE = {
	...
	'editCommentBox' :
				...
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
							'<h3 class="modal-title" id="myModalLabel">' + _t('编辑评论') + '</h3>'+
						'</div>'+
						...
						'<div class="modal-footer">'+
							'<span><input id="aw-do-delete" type="checkbox" value="1" name="do_delete" /><label for="aw-do-delete">' + _t('删除评论') + '</label></span>'+
	...
	'editCommentBoxshang' :
				...
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						...
						'<div class="modal-footer">'+
							'<span><input id="aw-do-delete" type="checkbox" value="1" name="do_delete" /><label for="aw-do-delete">' + _t('删除评论') + '</label></span> '+
							'<span> <input id="no-is-thief" type="checkbox" value="1" name="no_is_thief" /><label for="no-is-thief">' + _t('撤赏公开') + '</label></span>'+
							'<button class="btn btn-large btn-success" onclick="AWS.ajax_post($(\'#answer_edit\'), AWS.ajax_processer, \'ajax_post_alert\');return false;">' + _t('确定') + '</button>'+
						'</div>'+
						'</form>'+
					'</div>'+
	...
	'articleCommentBox' :
		'<div class="aw-article-replay-box clearfix">'+
			'<form action="'+ G_BASE_URL +'/article/ajax/save_comment/" onsubmit="return false;" method="post">'+
				...
				'</div>'+
				'<div class="mod-footer">'+
					'<a href="javascript:;" onclick="AWS.ajax_post($(this).parents(\'form\'));" class="btn btn-normal btn-success pull-right btn-submit">' + _t('评论') + '</a>'+
				'</div>'+
			'</form>'+
		'</div>',
		...
		'<div class="modal fade alert-box aw-question-redirect-box">'+
			'<div class="modal-dialog">'+
				'<div class="modal-content">'+
					'<div class="modal-header">'+
						'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
						'<h3 class="modal-title" id="myModalLabel">' + _t('话题重定向至') + '</h3>'+
					'</div>'+
					'<div class="modal-body">'+
						'<p>' + _t('将话题重定向至') + '</p>'+
						'<div class="aw-question-drodpwon">'+
							'<input id="question-input" class="form-control" type="text" data-id="{{data_id}}" placeholder="' + _t('搜索话题或话题 ID') + '" />'+
			...
			'<div class="modal fade alert-box aw-publish-box">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
							'<h3 class="modal-title" id="myModalLabel">' + _t('发起话题') + '</h3>'+
						'</div>'+
						'<div class="modal-body">'+
							'<div class="alert alert-danger hide error_message"><i class="icon icon-delete"></i> <em></em></div>'+
							'<form action="' + G_BASE_URL + '/publish/ajax/publish_question/" method="post" id="quick_publish" onsubmit="return false">'+
								...
								'<div>'+
									'<textarea class="form-control" placeholder="' + _t('写下你的话题') + '..." rows="1" name="question_content" id="quick_publish_question_content" onkeydown="if (event.keyCode == 13) { return false; }"></textarea>'+
									'<div class="aw-publish-suggest-question hide">'+
										'<p class="text-color-999">你的话题可能已经有答案</p>'+
										'<ul class="aw-dropdown-list">'+
										'</ul>'+
									'</div>'+
								'</div>'+
								'<textarea name="question_detail" class="form-control" rows="4" placeholder="' + _t('话题背景、条件等详细信息') + '..."></textarea>'+
								...
								'<div class="aw-topic-bar" data-type="publish">'+
									'<div class="tag-bar clearfix">'+
										'<span class="aw-edit-topic"><i class="icon icon-edit"></i>' + _t('编辑圈子') + '</span>'+
									'</div>'+
								'</div>'+
			...
			'<div class="modal fade alert-box aw-edit-comment-box aw-editor-box">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
							'<h3 class="modal-title" id="myModalLabel">' + _t('随机评论') + '</h3>'+
						'</div>'+
						'<div class="modal-body">'+
							'<div class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em></div>'+
							'<form action="' + G_BASE_URL + '/question/ajax/save_answer_fox/" method="post" id="quick_publish" onsubmit="return false">'+
								'<input type="hidden" name="post_hash" value="' + G_POST_HASH + '" />'+
								'<input id="foxid" class="form-control" type="hidden" placeholder="' + _t('相关话题不能为空') + '" name="foxid" value="{{foxid}}" />'+
								'<div class="aw-dropdown">'+
									'<p class="title">' + _t('没有找到相关结果') + '</p>'+
									'<ul class="aw-dropdown-list">'+
									'</ul>'+
								'</div>'+
								'<textarea class="form-control" id="foxreply_message" name="message" rows="3" placeholder="' + _t('评论内容...') + '"></textarea>'+
							'</form>'+
						'</div>'+
						'<div class="modal-footer">'+
							'<a data-dismiss="modal" aria-hidden="true" class="text-color-999">' + _t('取消') + '</a>'+
							'<button class="btn btn-large btn-success" onclick="AWS.ajax_post($(\'#quick_publish\'), AWS.ajax_processer, \'error_message\');">' + _t('评论') + '</button>'+
						'</div>'+
					'</div>'+
				'</div>'+
			'</div>',			
			...
			'<div class="modal fade alert-box aw-inbox">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
							'<h3 class="modal-title" id="myModalLabel">' + _t('话题置顶') + '</h3>'+
						'</div>'+
						'<div class="modal-body">'+
							'<div class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em></div>'+
							'<form action="' + G_BASE_URL + '/question/ajax/save_upday_fox/" method="post" id="quick_publish" onsubmit="return false">'+
								'<input type="hidden" name="post_hash" value="' + G_POST_HASH + '" />'+
								'<input id="foxid" class="form-control" type="hidden" placeholder="' + _t('相关话题不能为空') + '" name="foxid" value="{{foxid}}" />'+
								'<div class="aw-dropdown">'+
									'<p class="title">' + _t('没有找到相关结果') + '</p>'+
									...
									'</ul>'+
								'</div>'+
								'<input class="form-control laydate-icon" onclick="laydate({min: laydate.now(+1),max: laydate.now(+60)});" id="question_upday" name="question_upday" placeholder="' + _t('置顶日期...') + '">'+
							'</form>'+
						'</div>'+
						'<div class="modal-footer">'+
							'<a data-dismiss="modal" aria-hidden="true" class="text-color-999">' + _t('取消') + '</a>'+
							'<button class="btn btn-large btn-success" onclick="AWS.ajax_post($(\'#quick_publish\'), AWS.ajax_processer, \'error_message\');">' + _t('确定置顶') + '</button>'+
						'</div>'+
					'</div>'+
				'</div>'+
			'</div>',			
	...
	'editTopicBox' :
		'<div class="aw-edit-topic-box form-inline">'+
			'<input type="text" class="form-control" id="aw_edit_topic_title" autocomplete="off"  placeholder="' + _t('创建或搜索添加新圈子') + '...">'+
			...
			'<div class="modal fade alert-box aw-share-box aw-share-box-message aw-report-box" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
							'<h3 class="modal-title" id="myModalLabel">' + _t('举报话题') + '</h3>'+
						'</div>'+
	...
	'searchDropdownListQuestions' :
		'<li class="{{active}} question clearfix"><i class="icon icon-bestbg pull-left"></i><a class="aw-hide-txt pull-left" href="{{url}}">{{content}} </a><span class="pull-right text-color-999">{{discuss_count}} ' + _t('个评论') + '</span></li>',
	...
	'activityBox' :
		...
		'ajaxLogin' :
			'<div class="modal fade alert-box aw-ajax-login" id="aw-ajax-logins">'+
			'<div class="modal-dialog">'+
				'<div class="modal-content">'+
					'<div class="modal-header">'+
						'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
					...
					'</div>'+
					'<div class="modal-body">'+
						'<form id="login_form" method="post" onsubmit="return false" action="' + G_BASE_URL + '/account/ajax/login_process/">'+
							'<input type="hidden" name="return_url" value="{{return_url}}" />'+
								'<ul>'+
									...
									'<li class="last" style="overflow: hidden;">'+
										...
										'<a href="' + G_BASE_URL + '/account/openid/qq/bind/?return_url={{return_url}}" class="btn btn-large btn-qq"><i class="icon icon-qq"></i> 一键登录</a>'+
									'</li>'+
									'<li>'+
						...
						'<div class="s-login-form-bottom" style="height:22px;">'+
							'<a href="' + G_BASE_URL + '/account/find_password/" class="pull-left">忘记密码</a>'+
							'<span class="pull-right text-color-888">还没有帐号？<a href="' + G_BASE_URL + '/account/register/">点击注册</a></span>'+
						'</div>'+
					'</div>'+
				'</div>'+
			'</div>'+
				...
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							...
							'<h3 class="modal-title" id="myModalLabel"><img src="{{user_avatar}}" />对评论者[ {{user_name}} ]打赏</h3>'+
						'</div>'+
						'<div class="modal-body">'+
						'<div class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em></div>'+
						'<div class="modal-header qianbox_tem">'+
							'<p>' + _t('打赏是一种肯定') + '<span class="pull-right">您的钱包：{{rmb}}</span></p>'+
							'<div class="row">'+
								'<div class="col-md-3"><a class="btn btn-xs btn-warning" data-item_id="{{item_id}}" data-item_trueid="{{item_trueid}}" data-shangnum="1">1 元</a></div>'+
								'<div class="col-md-3"><a class="btn btn-xs btn-warning" data-item_id="{{item_id}}" data-item_trueid="{{item_trueid}}" data-shangnum="2">2 元</a></div>'+
								'<div class="col-md-3"><a class="btn btn-xs btn-warning" data-item_id="{{item_id}}" data-item_trueid="{{item_trueid}}" data-shangnum="5">5 元</a></div>'+
								'<div class="col-md-3"><a class="btn btn-xs btn-warning" data-item_id="{{item_id}}" data-item_trueid="{{item_trueid}}" data-shangnum="10">10 元</a></div>'+
								'<div class="col-md-3"><a class="btn btn-xs btn-warning" data-item_id="{{item_id}}" data-item_trueid="{{item_trueid}}" data-shangnum="20">20 元</a></div>'+
								'<div class="col-md-3"><a class="btn btn-xs btn-warning" data-item_id="{{item_id}}" data-item_trueid="{{item_trueid}}" data-shangnum="50">50 元</a></div>'+
								'<div class="col-md-3"><a class="btn btn-xs btn-warning" data-item_id="{{item_id}}" data-item_trueid="{{item_trueid}}" data-shangnum="100">100 元</a></div>'+
								'<div class="col-md-3"><a class="btn btn-xs btn-warning" data-item_id="{{item_id}}" data-item_trueid="{{item_trueid}}" data-shangnum="200">200 元</a></div>'+
							'</div>'+
						'</div>'+
						'<div class="modal-body" style="text-align:center;"><a style="color:#f60;" id="showdy">自定义打赏金额</a></div>'+
						'<div id="formbox" class="shangbox hide">'+
						'<form id="quick_pay" method="post" action="{{url}}" onsubmit="return false;">'+							
							'<input type="hidden" name="item_id" value="{{item_id}}">'+
							'<input type="hidden" name="item_trueid" value="{{item_trueid}}">'+
							'<input type="hidden" name="item_type" value="{{item_type}}">'+
							'<input type="text" id="shangnum" name="shangnum" class="form-control" placeholder="请输入您要打赏金额数字">'+
			...
			'<div class="modal fade alert-box aw-question-redirect-box">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>'+
							'<h3 class="modal-title" id="myModalLabel"><img src="{{user_avatar}}" />对评论者[ {{user_name}} ]评论偷看打赏</h3>'+
						'</div>'+
						'<div class="modal-body">'+
						'<div class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em></div>'+
						'<div class="modal-header qianbox_tem">'+
							'<p><span class="pull-left">您的钱包：{{rmb}}</span></p>'+
							'<div class="row">'+
								'<div class="col-md-12"><a class="btn btn-warning pull-right" data-item_id="{{item_id}}" data-item_trueid="{{item_trueid}}" data-shangnum="{{kanrmb}}">我要付费 {{kanrmb}} 元偷看啦</a></div>'+
							'</div>'+
						'</div>'+
					'</div>'+
				'</div>'+
	...
	'login' :
		'<div class="modal alert-box aw-ajax-login fade" id="aw-ajax-logins">'+
			'<div class="modal-dialog">'+
				'<div class="modal-content">'+
					'<div class="modal-header">'+
						'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
							'<h3 class="modal-title" id="myModalLabel">会员登陆</h3>'+
					'</div>'+
					'<div class="modal-body">'+
					'<div class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em></div>'+
						'<div class="login_form_left">'+
							'<form id="login_form" method="post" onsubmit="return false" action="' + G_BASE_URL + '/account/ajax/login_process/">'+
								'<input type="hidden" name="return_url" value="{{return_url}}" />'+
									'<ul>'+
										'<li>'+
											'<input type="text" id="aw-login-user-name" class="form-control" placeholder="手机号" name="user_tel" />'+
										'</li>'+
										'<li>'+
											'<input type="password" id="aw-login-user-password" class="form-control" placeholder="密码" name="password" />'+
										'</li>'+
										...
										'</li>'+
										'<li class="last" style="overflow: hidden;">'+
											'<a href="javascript:;" onclick="AWS.ajax_post($(\'#login_form\'), AWS.ajax_processer, \'error_message\');" id="login_submit" class="pull-left btn btn-large btn-block btn-primary">登录</a>'+
										'</li>'+
									'</ul>'+
									'<p class="margin-top-sm"><a href="account/find_password/" target="_blank">忘记密码</a><a href="account/register/" class="pull-right" target="_blank">免费注册</a></p>'+
							'</form>'+
						'</div>'+
					'</div>'+
				'</div>'+
