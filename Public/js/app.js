...
$(document).ready(function ()
{
	...
	$("#fontsize").click(function() {
		...
		if ($(this).hasClass('size_s')) {
			...
			_this.text("A+");
			_t.removeClass("font14").addClass("font18");
			_t.removeClass("line-big").addClass("line-bigs");
		} else {
			_this.removeClass("size_l").addClass("size_s");
			_this.text("A-");
			_t.removeClass("font18").addClass("font14");
			_t.removeClass("line-bigs").addClass("line-big");
		};
	});
    ...
    /*icon tooltips提示*/
    $(document).on('mouseover', '.follow, .voter, .aw-icon-thank-tips, .invite-list-user, .operate a, .box_thief a', function ()
    {
        $(this).tooltip('show');
    });
